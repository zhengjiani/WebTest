...
from projects.util.UpLoad import upload


class BasePage(PageObject):
    @property
    def url(self):
        return "http://zhengjiani.cn:8080/#/{0}".format(self.name)
...
class AddPage(PageObject):
    ...
    def add_user(self, name, phone, passwd, gender_key, level_key, state_key, birthday):
        ...
        self.wait_for_element_visibility(
            '#app > div > div.main-container > section > div > div.filter-container > button:nth-child(4)', 'visible',
            timeout=10)
        self.q(xpath='//*[@id="app"]/div/div[2]/section/div/div[1]/button[2]').click()
        self.wait_for_element_visibility(
            '#app > div > div.main-container > section > div > div.el-dialog__wrapper > div > div.el-dialog__footer > div > button.el-button.el-button--primary.el-button--medium',
            'visible', timeout=10)
        params = [[name, 1], [phone, 2], [passwd, 3]]
        for param in params:
            self.q(xpath='//*[@id="app"]/div/div[2]/section/div/div[4]/div/div[2]/form/div[{}]/div/div/input'.format(
    ...
    def add_keyword(self, keyword, link):
        ...
        self.q(
            xpath='//*[@id="app"]/div/div[2]/section/div/div[4]/div/div[2]/form/div[3]/div/div/div/span/span/i').click()
        self.q(xpath='/html/body/div[5]/div[1]/div[1]/ul/li[1]').click()
        self.q(
            xpath='//*[@id="app"]/div/div[2]/section/div/div[4]/div/div[2]/form/div[4]/div/div/div/span/span/i').click()
    ...
    def add_product(self, number, pname, zprice, cprice, pimgpath, drawpath):
        self.wait_for_element_visibility(
            '#app > div > div.main-container > section > div > div:nth-child(1) > div > form > div:nth-child(11) > div > button',
            'desc', timeout=10)
        params = [[number, 1], [pname, 2], [zprice, 3], [cprice, 4]]
        for param in params:
            self.q(xpath='//*[@id="app"]/div/div[2]/section/div/div[1]/div/form/div[{}]/div/div/input'.format(
                param[1])).fill(param[0])
    ...
    def add_ad(self, ad_title, ad_content, ad_img, ad_link):
        ...
        self.q(xpath='//*[@id="app"]/div/div[2]/section/div/div[4]/div/div[2]/form/div[2]/div/div/input').fill(
            ad_content)
        self.q(xpath='//*[@id="app"]/div/div[2]/section/div/div[4]/div/div[2]/form/div[3]/div/div/div').click()
        upload(ad_img)
    ...
    def add_topic(self, title, sub_title, topic_img, low_price, read_nums):
        ...
        self.q(xpath='//*[@id="app"]/div/div[2]/section/div/div[5]/div/div[2]/form/div[2]/div/div[1]/input').fill(
            sub_title)
        upload(topic_img)
        self.q(xpath='//*[@id="app"]/div/div[2]/section/div/div[5]/div/div[2]/form/div[5]/div/div/input').fill(
            low_price)
        self.q(xpath='//*[@id="app"]/div/div[2]/section/div/div[5]/div/div[2]/form/div[6]/div/div/input').fill(
            read_nums)
